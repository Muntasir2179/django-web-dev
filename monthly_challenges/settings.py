...
SECRET_KEY = 'django-insecure-viqpqbkjz*qy(l=#ojdbn5c=rp67c!41o^3usl9y83*%ig@x2x'
...
STATIC_URL = 'static/'   # setting for deployment

# django checks for static files in app specific directory
# This setting tells django to also look for the static files in the static folder in root project directory
STATICFILES_DIRS = [
    BASE_DIR / "static"
]
